...
- **[HOTFIX]**: Atualizado `vite-plugin-pwa` para `^0.21.1` e implementado filtro de logs no `vite.config.js` para silenciar avisos cosméticos de infraestrutura (`bundle variable`).
